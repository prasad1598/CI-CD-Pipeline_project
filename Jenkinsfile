    ...
    stages {
        ...
        stage ('uploading artifacts') {
            steps {
                ...
                nexusArtifactUploader artifacts: [[artifactId: 'Myapplication', classifier: '', file: 'target/Myapplication', type: 'war']], credentialsId: 'Nexus', groupId: 'Myapp', nexusUrl: '54.172.98.76:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'Hotstar', version: '8.3.3-SNAPSHOT'
            }
        }
        stage ('Deployment') {
            steps {
